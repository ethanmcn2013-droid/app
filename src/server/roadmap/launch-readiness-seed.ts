...
const SEED_ACTION_ITEMS: SeedActionItem[] = [
  ...
  // ─── Payments & Stripe ────────────────────────────────────────────
  { id: "AI-stripe-test-wedding", category: "Stripe", title: "Test purchase: Event €89 one-time", description: "Use test card 4242 4242 4242 4242; confirm checkout.session.completed webhook; entitlement row inserts; tier resolves correctly.", blockerId: null, priority: "P0" },
  ...
  { id: "AI-stripe-tax", category: "Stripe", title: "Decide Stripe Tax on/off for launch", description: "Event €89 + per-workspace mo are simple but US states vary. Decision: leave off for launch; revisit at $1k MRR.", blockerId: null, priority: "P2" },
  ...
  { id: "AI-demo-loop-seamless", category: "Demo polish", title: "Demo loop closes cleanly (frame 900 ≈ frame 0)", description: "Watch 3 cycles; look for snap or fade artifacts at the loop boundary.", blockerId: null, priority: "P1" },
