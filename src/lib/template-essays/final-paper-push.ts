...
export const essay: TemplateEssay = {
  ...
  sections: [
    {
      heading: "Why most “final paper checklists” fail you",
      body:
    ...
    },
    {
      ...
      body:
        "A Google Doc does not tell you what is late. A Notion template asks you to set up Notion. Tasks opens, the eight tasks are already there, and the lane your draft is sitting in is the only status update you need. Free covers a single paper - one workspace, three guests if you want a friend or a TA looking in. The student rate keeps Signal Studio at €9.99 a year when you want every class, assignment, and exam plan in one place. No sprints, no epics, no jargon - just the list, in the order you need it.",
    },
  ],
  closer:
