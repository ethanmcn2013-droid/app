...
export const essay: TemplateEssay = {
  templateId: "new-client-onboarding",
  seoTitle: "Freelance Client Onboarding Checklist — Free Template",
  seoDescription:
    "Kickoff doc, contract, payment terms, deposit invoice. The seven tasks every new freelance engagement needs in week one — drop them into a free workspace.",
  heroline: "The first week is when a freelance engagement is actually priced.",
  intro:
  ...
  sections: [
    {
      heading: "The kickoff doc isn’t paranoia. It’s the alignment artifact.",
      body:
