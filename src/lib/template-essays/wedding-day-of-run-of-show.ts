...
export const essay: TemplateEssay = {
  templateId: "wedding-day-of-run-of-show",
  seoTitle: "Wedding Day Timeline Template — Minute-by-Minute Run of Show",
  seoDescription:
    "A real wedding day-of run-of-show — 8 AM hair through 11 PM send-off. Free, editable, share with every vendor. No spreadsheet required.",
  heroline: "A wedding runs on schedule or it runs on the maid of honor.",
  intro:
