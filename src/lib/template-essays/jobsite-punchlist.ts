...
export const essay: TemplateEssay = {
  templateId: "jobsite-punchlist",
  seoTitle: "Jobsite Punchlist — Free Template for Trades",
  seoDescription:
    "Every callback handled before the final check clears. The end-of-job walkthrough list — touch-ups, caulk, outlet covers, inspection, final invoice, warranty docs.",
  heroline:
