...
export const essay: TemplateEssay = {
  ...
  seoTitle: "SaaS Product Launch Checklist — Free Template",
  seoDescription:
    "The launch plan PMMs and founders actually run from. Positioning, landing page, hero video, email, press, war room, post-mortem — all eight tasks, free.",
  heroline: "Launches don’t fail at the press list. They fail at the positioning doc.",
  intro:
  ...
  sections: [
    {
      heading: "Where launches actually break",
      body:
