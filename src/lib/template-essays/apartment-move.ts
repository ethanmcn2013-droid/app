...
export const essay: TemplateEssay = {
  templateId: "apartment-move",
  seoTitle: "Apartment Move Checklist — 30 Days Out, Free Workspace",
  seoDescription:
    "The moving checklist that protects your security deposit and keeps the lights on. Notice, movers, mail, utilities, walkthrough — drop it into a free workspace.",
  heroline: "Most people lose their deposit on move-out day. The damage was done weeks earlier.",
  intro:
  ...
  sections: [
    {
      heading: "The deposit isn’t lost at the walkthrough",
      body:
