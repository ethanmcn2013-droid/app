...
export const essay: TemplateEssay = {
  ...
  sections: [
    {
      heading: "The load-bearing task is the outreach one",
      body:
    ...
    {
      heading: "Practice out loud or don’t practice",
      body:
    ...
    },
    {
      ...
      body:
        "If you are applying to one job, the free tier is enough - one workspace, three editing guests, which is room for a peer reviewer and a mentor to mark up your resume bullets. If you are running a real search across five or ten roles, each one wants its own workspace: different company research, different outreach list, different team to memorize. The student rate gives you Signal Studio for €9.99 a year with any working student email, so every application can have its own calm pipeline.",
    },
  ],
  closer:
