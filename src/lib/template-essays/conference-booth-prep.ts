...
export const essay: TemplateEssay = {
  templateId: "conference-booth-prep",
  seoTitle: "Conference Booth Checklist — Free SaaS Trade Show Template",
  seoDescription:
    "The trade show booth prep list PMMs and founders actually work from. Booth, signage, demo flow, swag, lead capture, shifts, follow-up — eight tasks, free.",
  heroline: "The booth doesn’t convert at the booth.",
  intro:
  ...
  sections: [
    {
      heading: "Where booth budgets actually leak",
      body:
