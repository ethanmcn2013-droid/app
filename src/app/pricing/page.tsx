...
const TIERS: Tier[] = [
  ...
  },
  {
    ...
    features: [
      ...
      "Tasks AI nudges — what's stuck, what's slipping",
      "Custom themes + workspace cover art",
    ],
  ...
  },
  {
    ...
    features: [
      ...
      "Premium wedding templates · 200-guest run-of-show",
      "Printable PDF timeline for the day-of binder",
      "Seating-chart and RSVP-import helpers",
      "Custom OG cards for the save-the-date link",
    ],
    cta: "Buy once",
    tier: "wedding",
    accent: "specialty",
