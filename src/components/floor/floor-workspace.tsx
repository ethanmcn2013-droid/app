...
export function FloorWorkspace({
  view, tasks, projectName, taskId, children, onOpenPlanning,
}: FloorWorkspaceProps) {
  ...
  return (
    ...
    >
      {/* v3 shell: navigation, search and account live in the App sidebar and top bar. */}

      {/* ── the sheet ─────────────────────────────────────────── */}
      <div className={styles.sheet} data-sheet="">
        <div className={styles.head} data-floor-head="">
