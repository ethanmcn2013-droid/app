...
import { MonthlyTemplateChoice } from "./monthly-template-choice";
import type {
  ProjectsTreeData,
  ProjectsTreeLeaf,
...
const TEMPLATE_CHOICE_CLASSES = {
  wrap: styles.templateChoiceWrap,
  choice: styles.templateChoice,
  help: styles.templateChoiceHelp,
  status: styles.templateChoiceStatus,
};
  ...
  if (adding) {
    return (
      <li>
        ...
        ><MonthlyTemplateChoice classNames={TEMPLATE_CHOICE_CLASSES} pending={pending} startTransition={startTransition} onCreated={() => {
          setAdding(false);
          setDraft("");
          onCreated?.();
        }} /></div> : null}
