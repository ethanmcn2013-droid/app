...
export function ListApp() {
  ...
  const grouped: Record<LaneId, Task[]> = {
    todo: [],
    doing: [],
    review: [],
    done: [],
  };
  for (const t of tasks) grouped[t.lane].push(t);
                ...
                return (
                  ...
                  >
                    <div className="flex items-center gap-2.5">
                      <button className="flex h-4 w-4 items-center justify-center rounded border border-line-soft text-transparent hover:border-ink-soft hover:text-ink-soft">
