...
**Latest complete published Linux checkpoint: 3be4ea9623acda261e47fe330e40e223d9a1671d.** [CI33961627091](https://github.com/ethanmcn2013-droid/app/actions/runs/33961627091), [Verify33961627087](https://github.com/ethanmcn2013-droid/app/actions/runs/33961627087) and [Design33961627079](https://github.com/ethanmcn2013-droid/app/actions/runs/33961627079) all pass. The tested merge b5a6cfa8 has exactly candidate3be tree323625ba; the complete132-case artifact and all logs are preserved by4a70d3f4 in the owning UI evidence directory. This supersedes6eb for the custody/focus UI only, without changing historical scope or asserting provider/human/receiving acceptance.
...
The later migration-free **1ac3d2335b68a02594f4e8c68793a962090f9579**, sealed with evidence atce25e4ef and integrated at3b771639, exposes counts of unconfirmed named-user permission removals for current/previous project folders after the live read. Actual SQLite/SSR26 checks, five independent controls and a passing control against the preserved parent failure pass. The saved component matrix has46 cases/52 screenshots. Identity, actions and provider responses are explicit synthetic ports, not a live Google lifecycle. [Owning pending-removal evidence](../../../experience/reviews/january-drive-pending-removal-2026-09-05/REPORT.md). This later source still needs its complete candidate gates;3be Linux does not cover it.

The separate actual-service/SQLite investigation confirms personal token disconnect still lacks durable requested/confirmed facts, and a no-current retry can imply confirmation without evidence. That receipt/reconnect-generation work remains agent-owned and open. A pending file-permission notice does not close it. Full Drive acceptance remains open.
