...
const SEATS = [
  ...
  },
  {
    ...
    "lens": "Two people planning their own wedding, tired, on a laptop, who have never used project-management software and will not read a manual has to run their work from this. Comprehension without training. Is the most important thing on screen the most prominent thing. Duplicated, missing, or twice-named information. Dense and empty states."
  },
  {
    "key": "brand",
    "name": "Brand and copy",
