...
FINDING id=fortnight-marker-lands-beside-a-fifteen-day-tick
Seat: Brand and copy
Element: The ages strip - the "A fortnight" marker at 14 days against the ticks today / 15d / 30d / 45d
Problem: The product's one named threshold is fourteen days, and it is what three of the five status cards are counted on. The axis is ruled in fives, so the threshold line stands one day left of a 15d tick and its label prints directly above it, 40px apart at 1440 and closer at 768.
Consequence claimed: A reader ruling the threshold off the axis reads it as fifteen days, and a job at fourteen days sits on the wrong side of the number she just read. The threshold is the whole basis of the slipping story.
Severity claimed: refinement
Proposed fix: Rule the axis on the threshold rather than on fives: marks at 0, 14, 28 and 42, labelled today, 14d, 28d, 42d, so the fortnight marker and a tick coincide.
...
Write the JSON to C:\Users\ethan\signal-studio-workspace\_wt-home-analytics\docs\design\labs\home-analytics-2026-08\panel\round-1\refuters\fortnight-marker-lands-beside-a-fifteen-day-tick.json.
