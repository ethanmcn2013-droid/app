export const meta = {
  name: 'master-suite-panel-round-4',
...
log(`round 4: ${alive.length} seats, ${confirmed.length} confirmed, ${refuted.length} refuted (${Math.round(refuteRate * 100)}%)`)
