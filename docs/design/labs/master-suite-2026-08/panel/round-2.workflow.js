export const meta = {
  name: 'master-suite-panel-round-2',
  description: '3 fresh independent seats grade the master-suite master against a 9.5 bar',
  phases: [
    { title: 'Review' },
    { title: 'Verify' },
  ],
...
log(`round 2: ${alive.length} seats, ${confirmed.length} confirmed, ${refuted.length} refuted (${Math.round(refuteRate * 100)}%)`)
